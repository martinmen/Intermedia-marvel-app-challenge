...
private val  retrofit = UtilsApiMarvel.getRetrofit()
    ...
    suspend fun getHeroes():List<baseResponse>{
        return withContext(Dispatchers.IO){
            val response=retrofit.create(MarvelService::class.java).getAllHeroes(authParams.apiKey,authParams.hash,authParams.ts.toString())//,offset,limit
